...
namespace CL.ReportGenerator
{
    ...
    {
        /// <summary>
        /// Generate a PDF to a list of objects
        /// </summary>
        ...
        /// <param name="orientation"></param>
        /// <returns></returns>
        Task<IActionResult> GenerateReportAsPDFSingleDoc<TModel>(string fileName, string reportPath, string query, object param = null, CommandType type = CommandType.Query, ReportOrientation reportOrientation = ReportOrientation.Portrait);
        /// <summary>
        /// 
        /// </summary>
        /// <typeparam name="TModel"></typeparam>
